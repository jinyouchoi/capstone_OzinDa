...
def motionhint():
    ...
    gameDisplay.blit(name1, (430, 640))
    gameDisplay.blit(name2, (700, 640))
    gameDisplay.blit(name3, (970, 640))
...
####
                    ...
                    if submit_button_click == True: #제출하기 클릭
                        if now_motion_count == to_do_num:
                            ...
                            gameDisplay.blit(level_complete, (520, 100))
                            gameDisplay.blit(nextLevel, (nxButton_x, nxButton_y))
                            nextLevelButton = Button(nextLevel, nxButton_x, nxButton_y, nextLevel.get_width() + 30, nextLevel.get_height() + 30,
                                                  nextLevel, nxButton_x, nxButton_y, None)
